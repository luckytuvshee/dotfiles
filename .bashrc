...
# laravel
export PATH=/home/luckytuvshee/.config/composer/vendor/bin:$PATH

# ngrok
export PATH=/home/luckytuvshee/.local/bin/ngrok:$PATH
...
# MTP
function gv() {
	if [ -z "$(ls -A /var/run/user/1000/gvfs)" ]; then
  	echo "No MTP connected"
	else
		cd /var/run/user/1000/gvfs && cd $(ls -d */|head -n 1)/Phone
	fi
}

# Restart GNOME shell
alias reshell='killall -SIGQUIT gnome-shell'

# Anaconda Navigator
alias conda-nav='anaconda-navigator'
