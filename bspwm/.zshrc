...
toilet -f term -F border "$(/home/luckytuvshee/tty_login/check_update.sh)"
...
# export PATH="/home/luckytuvshee/anaconda3/bin:$PATH"  # commented out by conda initialize
...
# disable checking status of git repo
# or just uncomment at the bottom
DISABLE_UNTRACKED_FILES_DIRTY="true"

alias daemon-re='sudo systemctl daemon-reexec'
...
__conda_setup="$('/home/luckytuvshee/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/luckytuvshee/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/luckytuvshee/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/luckytuvshee/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
